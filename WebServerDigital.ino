...
//************************************************************************************************
// SSID & Password
const char* ssid = "iPhone200";  // Enter your SSID here 
const char* password = "digital3";  //Enter your Password here
WebServer server(80);  // Object of WebServer(HTTP port, 80 is defult)
uint8_t LED1pin = 2;//LED ESP
//-----------PUERTOS UTILIZADOS EN ESP---------------
uint8_t LED2pin = 14; // LED1 UTR 1
uint8_t LED3pin = 12; // LED2 UTR 1
